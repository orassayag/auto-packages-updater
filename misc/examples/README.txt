...
'name'                      - (Required) The project's name, which will be displayed both in the console and in the result TXT file in the 'dist' directory.
...
                              'custom' - Take only specific package names that are found in 'custom-packages-path' file. Without any value in the
